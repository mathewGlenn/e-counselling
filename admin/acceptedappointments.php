...
<body>
  ...
  <div class="w-100">
    ...
    <div class="main">
      <span class="page-title">Accepted appointments</span>
      <div class="mt-5">
        <table class="table table-hover">
          ...
          <tbody id="tbody">
            <?php
            $sql = "SELECT * FROM tblappointment WHERE appointment_status='accepted' ORDER BY id DESC;";
            ...
            if ($resultCheck > 0) {
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr style='cursor: context-menu;'>
                  ...
                  <td>$arrangement</td>
                  <td>
                    <a href='acceptedappointmentinformation.php?id=$id'>
