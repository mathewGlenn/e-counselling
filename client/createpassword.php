        ...
        <div class="d-flex flex-column align-items-center justify-content-center" style="height: 100%;">  
          ...
          <div class="mt-4 d-flex flex-column">
              ...
              <div class=" d-flex flex-column"> 
                ...
                <input id="password" type="text" class="m-input">

                <span class="m-label mt-3">Confirm Password</span>
                <input id="confirmPasswprd" type="text" class="m-input">
               </div>
    
          </div>
          <button class="submit mt-4 mb-5" onclick="btnSave()">Finish Signup</button>
        </div>
      </div>
    </div>
