        ...
        <div class="card bg-glass">
          <div class="card-body px-4 py-5 px-md-5">
            ...
            <form>
              ...
              <button type="button" class="btn mt-4" style="width: 100%; background-color: #ffaa01" id="login" onclick="btnContinue()">Continue</button>
            </form>
          </div>
        </div>
      </div>
        ...
        $.ajax({
            ...
            success:function(data) {
              ...
              if(data == "empty") {
                ...
                window.location.href = 'fillinfo.php';
              }
            }
        });
      }
